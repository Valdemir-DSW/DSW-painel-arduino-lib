...
DSWPainelPro dsw;
////////////////////////////
int power = 0;    // a nossa variável que vai ser usadas no teste
///////////////////////
//fazendo inicialização da parte eeprom do dsw
void* variaveis[] = { &power }; // estamos as variáveis que queremos fazer backup/salvar e  puxar
char tipos[] = { 'i'};          // na respectiva ordem a tipologia da var "i" = int | "f" = float
dsw_eeprom eepromManager(variaveis, tipos, 1);
//////////////////////////
...
void meuCallback(String command, int valuer) {
  ...
  */
   ...
   if (command == "/led"){
     power = (int)dsw.cmd_puxada("/led");
      eepromManager.eeprom_salvar(); // como o valor foi atualizado vamos salvar tudo ou seja fazer um backup
      /*
...
void setup() {
     // na hora do Arduíno ligar puxa todos os valores salvos
